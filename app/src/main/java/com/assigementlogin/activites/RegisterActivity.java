...
public class RegisterActivity extends AppCompatActivity {
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validate()) {
                    ...
                    String Email = editTextMobileNo.getText().toString();
                    String Password = editTextPassword.getText().toString();

                    //Check in the database is there any user associated with  this email
                    if (!sqliteHelper.isMobileExists(Email)) {
                        ...
                        Snackbar.make(buttonRegister, "User already exists with same mobile ", Snackbar.LENGTH_LONG).show();
                    }
    ...
    public boolean validate() {
        ...
        if (!Patterns.PHONE.matcher(Mobile).matches()) {
            valid = false;
            textInputLayoutMobile.setError("Please enter valid mobile!");
        } else {
            valid = true;
